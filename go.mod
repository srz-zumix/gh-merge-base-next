module github.com/srz-zumix/gh-merge-base-next

go 1.26.1

require github.com/srz-zumix/go-gh-extension v0.6.14

require github.com/google/go-github/v90 v90.0.0 // indirect
